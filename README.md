...
🚀 Getting Started
Ensure Git LFS is installed on your machine before cloning the repository.

Open the project in Unity (6000.0.58f2 recommended).

Verify that both MainMenu and Game scenes are included in the Build Settings.

Launch the MainMenu scene to begin.
